...
_PHASE_HINTS = {
    ...
    "AFTER_DRAFT": (
        "Драфт завершён или ещё идёт, пики героев переданы в контексте. Это самый "
        "информативный момент: состав героев часто говорит о шансах больше, чем "
        "рейтинги команд. Опирайся прежде всего на них.\n"
        "ВАЖНО ПРО ЦЕНУ. Между снимком и исполнением проходит несколько минут: "
        "трансляция идёт с задержкой, ты думаешь, оператор подтверждает. За это "
        "время рынок увидит те же пики и сдвинется — обычно против тебя, если "
        "твоя оценка верна. Поэтому max_acceptable_price ставь с запасом к цене "
        "из снимка, но не выше собственного порога безубыточности: лучше не "
        "исполниться, чем купить дороже, чем позволяет твоя оценка. Если "
        "преимущество меньше типичного сдвига цены на драфте, честнее HOLD."
    ),
    "BETWEEN_MAPS": (
